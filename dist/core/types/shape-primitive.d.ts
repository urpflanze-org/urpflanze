 ...
 * @category Core.Types
 */
export declare type TShapeLoopGeneratorFormula = (shape_loop_repetition: IShapeLoopRepetition, prop_arguments: ISceneChildPropArguments) => Array<number> | Float32Array;
/**
 *
 * @category Core.Interfaces
 */
